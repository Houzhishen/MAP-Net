...
class sun_load(object):
    """
    Dataset statistics:
    # 64 * 600 (train) + 16 * 600 (val) + 20 * 600 (test)
    """
    dataset_dir = '/home/abc/Datasets/sun/npz/'

    def __init__(self, **kwargs):
        super(sun_load, self).__init__()
        self.train_dir = os.path.join(self.dataset_dir, 'sun-train.npz')
        self.val_dir = os.path.join(self.dataset_dir, 'sun-val.npz')
        self.test_dir = os.path.join(self.dataset_dir, 'sun-test.npz')
