...
class FewShotDataset_test(Dataset):
    ...
    def _creatExamplesTensorData(self, examples):
        ...
        return images, wordembs, labels

    def __getitem__(self, index):
        Tnovel = self.Epoch_Tnovel[index]
        Exemplars = self.Epoch_Exemplar[index]
        S_imgs, S_words, S_labels = self._creatExamplesTensorData(Exemplars)
        Q_imgs, Q_words, Q_labels = self._creatExamplesTensorData(Tnovel)
        return S_imgs, S_words, S_labels, Q_imgs, Q_words, Q_labels
